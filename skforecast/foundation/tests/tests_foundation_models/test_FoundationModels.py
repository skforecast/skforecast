...
from ..tests_forecaster_foundation.fixtures_forecaster_foundation import (
    FakePipeline,
)
...
# Tests FoundationModels.__init__
# ==============================================================================
def test_FoundationModels_init_creates_Chronos2Adapter():
    """
    Test that FoundationModels creates an internal Chronos2Adapter on init.
    """
...
def test_Chronos2Adapter_allow_exogenous_is_True():
    ...
    assert FoundationModel("autogluon/chronos-2-small", pipeline=FakePipeline()).adapter.allow_exogenous is True


def test_FoundationModels_init_model_id_stored_in_adapter():
    """
...
def test_FoundationModels_init_kwargs_forwarded_to_adapter():
    """
...
# Tests FoundationModels.is_fitted
# ==============================================================================
def test_FoundationModels_is_fitted_is_false_before_fit():
    """
...
def test_FoundationModels_is_fitted_is_true_after_fit():
    """
...
def test_FoundationModels_allow_exogenous_is_True_for_chronos():
    """
...
def test_FoundationModels_allow_exogenous_delegates_to_adapter():
    """
...
def test_FoundationModels_init_context_length_attribute_default():
    """
...
def test_FoundationModels_init_context_length_attribute_when_set():
    """
    context_length attribute reflects the value passed at construction.
    """
    m = FoundationModel("autogluon/chronos-2-small", context_length=128)
    assert m.context_length == 128
    assert m.context_length == m.adapter.context_length


def test_FoundationModels_set_params_updates_context_length_attribute():
    """
...
# Tests FoundationModels.fit
# ==============================================================================
def test_FoundationModels_fit_returns_self():
    """
    Test that fit returns the FoundationModels instance.
    """
    m = FoundationModel("autogluon/chronos-2-small")
...
def test_FoundationModels_fit_delegates_to_adapter():
    """
...
def test_FoundationModels_fit_raises_TypeError_when_series_is_invalid_type():
    """
...
# Tests FoundationModels.predict
# ==============================================================================
def test_FoundationModels_predict_raises_ValueError_when_not_fitted_and_no_last_window():
    """
    Test predict raises ValueError when model is not fitted and no last_window.
    """
    m = FoundationModel("autogluon/chronos-2-small")
...
def test_FoundationModels_predict_raises_ValueError_when_steps_not_positive(steps):
    """
...
def test_FoundationModels_predict_raises_ValueError_when_quantile_out_of_range(bad_quantile):
    """
...
def test_FoundationModels_predict_returns_dataframe_for_point_forecast():
    """
    Test that predict returns a long-format DataFrame when quantiles=None.
    """
    m = FoundationModel("autogluon/chronos-2-small", pipeline=FakePipeline())
    m.fit(series=y)
...
def test_FoundationModels_predict_series_has_correct_length():
    """
...
def test_FoundationModels_predict_returns_dataframe_for_quantiles():
    """
...
def test_FoundationModels_predict_uses_last_window():
    """
...
def test_FoundationModels_predict_passes_future_exog_to_pipeline():
    """
...
# Tests FoundationModels.predict — exact predicted values
# ==============================================================================
def test_FoundationModels_predict_point_forecast_exact_values():
    """
    ...
    pd.testing.assert_index_equal(result.index, expected_index)
    np.testing.assert_array_almost_equal(result["pred"].to_numpy(), expected_values)


def test_FoundationModels_predict_quantile_forecast_exact_values():
    """
...
# Tests FoundationModels — cross_learning parameter
# ==============================================================================
def test_FoundationModels_init_cross_learning_forwarded_to_adapter():
    """
    Test that cross_learning=True is forwarded to the underlying adapter.
    """
    m = FoundationModel("autogluon/chronos-2-small", cross_learning=True)
    assert m.adapter.cross_learning is True


def test_FoundationModels_init_cross_learning_default_is_false():
    """
...
# Tests FoundationModels.fit — multi-series
# ==============================================================================
def test_FoundationModels_fit_multiseries_wide_dataframe_setsis_multiple_series_():
    """
    Test that fit on a wide DataFrame delegates correctly and sets is_multiple_series_.
    """
    m = FoundationModel("autogluon/chronos-2-small")
    m.fit(series=_y_wide_ms)
    assert m.adapter.is_multiple_series_ is True
    assert m.is_fitted is True


def test_FoundationModels_fit_multiseries_dict_setsis_multiple_series_():
    """
    Test that fit on a dict of Series delegates correctly and sets is_multiple_series_.
    """
    m = FoundationModel("autogluon/chronos-2-small")
...
def test_FoundationModels_fit_multiseries_returns_self():
    """
    Test that fit in multi-series mode returns the FoundationModels instance.
    """
    m = FoundationModel("autogluon/chronos-2-small")
...
def test_FoundationModels_fit_multiseries_stores_history_dict():
    """
...
# Tests FoundationModels.predict — multi-series
# ==============================================================================
def test_FoundationModels_predict_multiseries_point_returns_long_dataframe():
    """
...
def test_FoundationModels_predict_multiseries_point_correct_length():
    """
...
def test_FoundationModels_predict_multiseries_quantile_returns_long_dataframe():
    """
...
def test_FoundationModels_predict_multiseries_cross_learning_forwarded_to_pipeline():
    """
    Test that cross_learning is forwarded all the way to predict_quantiles.
    """
    pipeline = FakePipeline()
    m = FoundationModel("autogluon/chronos-2-small", pipeline=pipeline, cross_learning=True)
    m.fit(series=_y_dict_ms)
    m.predict(steps=3)
    assert pipeline.last_kwargs.get("cross_learning") is True


def test_FoundationModels_predict_multiseries_last_window_wide_dataframe():
    """
...
def test_FoundationModels_predict_multiseries_last_window_dict():
    """
...
def test_FoundationModels_predict_multiseries_exact_point_values():
    """
...
# Tests FoundationModel.get_params / set_params
# ==============================================================================

def test_FoundationModels_get_params_returns_expected_keys():
    """
...
def test_FoundationModels_get_params_returns_correct_values():
    """
...
def test_FoundationModels_set_params_invalid_key_raises_ValueError():
    """
...
def test_FoundationModels_init_model_id_attribute():
    """
...
def test_FoundationModels_set_params_updates_model_id_attribute():
    """
...
def test_FoundationModel_init_raises_ValueError_for_unknown_model():
    """
...
# Tests FoundationModel.set_params — model → model_id translation
# ==============================================================================
def test_FoundationModels_set_params_model_translates_to_model_id():
    """
...
def test_FoundationModels_set_params_model_resets_pipeline():
    """
...
def test_FoundationModels_set_params_non_pipeline_key_no_pipeline_reset():
    """
...
def test_FoundationModels_set_params_error_message_says_FoundationModel():
    """
    Test that an invalid-key error from set_params names 'FoundationModel',
