...
def test_arima_predict_air_passengers_data():
    ...
    if platform_name == 'Linux':
        ...
        expected_coef = np.array([
            0.57642312,  0.23033487, -0.9809854 , -0.94305618,  0.86890625
        ])
        expected_pred = np.array([
            448.10999394, 423.88508584, 458.38761236, 498.20339728,
            510.33873671, 568.95580832, 656.73992256, 641.9792931 ,
            547.14322261, 497.94122447
        ])
...
def test_arima_predict_multi_seasonal_data():
    ...
    if platform_name == 'Linux':
        ...
        expected_coef = np.array([
            -0.50725741, -0.04581745, -0.0402695 ,  0.01614707, -0.06012496,
            -0.48475649, -0.51518132, -0.04679703, -0.97504813
        ])
        expected_pred = np.array([
            174.62986768, 168.91085586, 173.56011219, 172.08594069,
            173.80506766, 171.86031321, 175.37696442, 173.56648761,
            172.88189364, 173.39539995
        ])
...
def test_arima_predict_auto_arima_air_passengers_data():
    ...
    expected_pred = {
        ...
        'Windows': 
            np.array([
                445.56840264, 420.2879122 , 449.05033016, 491.65721997,
                503.180763  , 566.62156657, 653.99538633, 638.31172225,
                540.57958457, 493.8063581
            ])
    }
