...
@pytest.mark.parametrize("forecaster, refit, n_jobs_expected", 
    [(ForecasterRecursive(estimator=LinearRegression(), lags=2), True, 1),
     ...
     (ForecasterRecursive(estimator=HistGradientBoostingRegressor(), lags=2), 1, max(1, cpu_count() - 1)),
     (ForecasterRecursive(estimator=HistGradientBoostingRegressor(), lags=2), 2, 1),
     (ForecasterRecursive(estimator=HistGradientBoostingRegressor(), lags=2), 0, max(1, cpu_count() - 1)),
     (ForecasterRecursive(estimator=LGBMRegressor(n_jobs=1), lags=2), True, max(1, cpu_count() - 1)),
     (ForecasterRecursive(estimator=LGBMRegressor(n_jobs=1), lags=2), False, max(1, cpu_count() - 1)),
     ...
     (ForecasterRecursiveClassifier(estimator=LGBMClassifier(n_jobs=1), lags=2), True, max(1, cpu_count() - 1)),
     (ForecasterRecursiveClassifier(estimator=LGBMClassifier(n_jobs=1), lags=2), False, max(1, cpu_count() - 1)),
     ...
     (ForecasterRecursiveMultiSeries(estimator=LinearRegression(), lags=2), True, max(1, cpu_count() - 1)),
     (ForecasterRecursiveMultiSeries(estimator=LinearRegression(), lags=2), 2, 1),
     (ForecasterRecursiveMultiSeries(estimator=LinearRegression(), lags=2), False, max(1, cpu_count() - 1)),
     (ForecasterRecursiveMultiSeries(estimator=HistGradientBoostingRegressor(), lags=2), 1, max(1, cpu_count() - 1)),
     (ForecasterRecursiveMultiSeries(estimator=HistGradientBoostingRegressor(), lags=2), 2, 1),
     (ForecasterRecursiveMultiSeries(estimator=HistGradientBoostingRegressor(), lags=2), 0, max(1, cpu_count() - 1)),
     (ForecasterRecursiveMultiSeries(estimator=LGBMRegressor(n_jobs=1), lags=2), True, max(1, cpu_count() - 1)),
     (ForecasterRecursiveMultiSeries(estimator=LGBMRegressor(n_jobs=1), lags=2), False, max(1, cpu_count() - 1)),
