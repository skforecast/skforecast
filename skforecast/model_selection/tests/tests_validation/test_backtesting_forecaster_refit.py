...
def test_output_backtesting_forecaster_interval_yes_exog_yes_remainder_gap_with_mocked():
    ...
    expected_predictions = pd.DataFrame(
        data = np.array([[ 0.65022999,  0.32111688,  1.0092382 ],
                        ...
                        [ 0.54075007,  0.20683169,  0.8966551 ],
                        [ 0.50283999,  0.19947461,  0.85291605],
                        [ 0.49737535,  0.17669038,  0.84772905],
                        [ 0.49185456,  0.15793618,  0.83986246],
                        [ 0.48906044,  0.14530175,  0.8391365 ],
                        [ 0.27751064, -0.02499172,  0.67524686],
                        [ 0.25859617, -0.09051231,  0.59235376],
                        [ 0.32853669,  0.01962394,  0.6910329 ],
                        [ 0.43751884,  0.13444931,  0.75663214],
                        [ 0.33016371,  0.01926221,  0.69265992],
                        [ 0.58126262,  0.21945267,  0.97135055],
                        [ 0.52955296,  0.16642539,  0.94752912]]),
        columns = ['pred', 'lower_bound', 'upper_bound'],
