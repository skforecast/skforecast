...
def test_output_backtesting_forecaster_no_refit_interval_yes_exog_bootstrapping():
    """
    ...
    expected_predictions = pd.DataFrame(
        data = np.array([
            [0.55538506, 0.2231571 , 0.5447175 , 0.45249635, 0.55335243,
                0.52863287, 0.40987702, 1.08832438, 0.50028437, 0.81325102,
                0.50028437],
            [0.44124674, 0.5913199 , 0.28901421, 0.08781536, 0.41383506,
                0.11251819, 0.56349706, 0.46538984, 0.57044472, 0.66202458,
                0.3966169 ],
            [0.49752366, 0.28985382, 0.45865949, 0.57580758, 1.02203331,
                0.92991459, 0.71749157, 0.23488573, 0.40651704, 0.55856215,
                0.15394952],
            [0.53822797, 0.31583597, 0.39743266, 0.67229824, 0.8427274 ,
                0.91316872, 1.08587068, 0.69987489, 0.31953911, 0.41305754,
                0.43415083],
            [0.4793552 , 0.33550194, 0.94540952, 0.96808639, 0.39785977,
                0.10508895, 0.63905593, 0.26431943, 0.55435426, 0.51671742,
                0.46012543],
            [0.4474213 , 0.11519334, 0.43675374, 0.34453259, 0.44538867,
                0.42066911, 0.30191326, 0.98036062, 0.39232061, 0.70528726,
                0.39232061],
            [0.51546009, 0.66553324, 0.36322756, 0.16202871, 0.48804841,
                0.18673153, 0.63771041, 0.53960319, 0.64465807, 0.73623793,
                0.47083025],
            [0.54066381, 0.33299397, 0.50179963, 0.61894773, 1.06517346,
                0.97305474, 0.76063172, 0.27802588, 0.44965718, 0.60170229,
                0.19708967],
            [0.51970475, 0.29731275, 0.37890944, 0.65377502, 0.82420418,
                0.8946455 , 1.06734746, 0.68135167, 0.30101589, 0.39453432,
                0.41562761],
            [0.51420212, 0.37034887, 0.98025645, 1.00293332, 0.4327067 ,
                0.13993588, 0.67390286, 0.29916636, 0.58920119, 0.55156435,
                0.49497236],
            [0.4699511 , 0.13772315, 0.45928355, 0.36706239, 0.46791847,
                0.44319891, 0.32444306, 1.00289043, 0.41485042, 0.72781707,
                0.41485042],
            [0.55077981, 0.70085296, 0.39854727, 0.19734843, 0.52336813,
                0.22205125, 0.67303012, 0.5749229 , 0.67997779, 0.77155765,
                0.50614997],
            [0.54063198, 0.33296215, 0.50176781, 0.6189159 , 1.06514163,
                0.97302291, 0.76059989, 0.27799405, 0.44962536, 0.60167047,
                0.19705785],
            [0.48476663, 0.26237464, 0.34397133, 0.6188369 , 0.78926607,
                0.85970739, 1.03240935, 0.64641355, 0.26607778, 0.3595962 ,
                0.3806895 ],
            [0.49651396, 0.3526607 , 0.96256829, 0.98524516, 0.41501854,
                0.12224772, 0.6562147 , 0.2814782 , 0.57151303, 0.53387618,
                0.4772842 ],
            [0.59616217, 0.26393422, 0.58549462, 0.49327346, 0.59412954,
                0.56940998, 0.45065413, 1.1291015 , 0.54106149, 0.85402814,
                0.54106149],
            [0.46166238, 0.61173553, 0.30942984, 0.10823099, 0.43425069,
                0.13293382, 0.58391269, 0.48580547, 0.59086036, 0.68244021,
                0.41703253],
            [0.55197041, 0.34430057, 0.51310623, 0.63025433, 1.07648006,
                0.98436134, 0.77193832, 0.28933248, 0.46096378, 0.61300889,
                0.20839627],
            [0.5694184 , 0.3470264 , 0.42862309, 0.70348867, 0.87391783,
                0.94435915, 1.11706111, 0.73106532, 0.35072954, 0.44424797,
                0.46534127],
            [0.52086432, 0.37701106, 0.98691865, 1.00959552, 0.4393689 ,
                0.14659808, 0.68056506, 0.30582856, 0.59586339, 0.55822654,
                0.50163456]]),
...
def test_output_backtesting_forecaster_no_refit_interval_distribution_yes_exog():
    ...
    expected_predictions = pd.DataFrame(
        data = np.array([
            [0.55538506, 0.57769255, 0.22062059],
            [0.44124674, 0.42000521, 0.21356279],
            [0.49752366, 0.48827023, 0.21372037],
            [0.53822797, 0.53381089, 0.20429916],
            [0.4793552 , 0.478654  , 0.22438172],
            [0.4474213 , 0.46972879, 0.22062059],
            [0.51546009, 0.49421855, 0.21356279],
            [0.54066381, 0.53141037, 0.21372037],
            [0.51970475, 0.51528767, 0.20429916],
            [0.51420212, 0.51350093, 0.22438172],
            [0.4699511 , 0.4922586 , 0.22062059],
            [0.55077981, 0.52953827, 0.21356279],
            [0.54063198, 0.53137855, 0.21372037],
            [0.48476663, 0.48034956, 0.20429916],
            [0.49651396, 0.49581276, 0.22438172],
            [0.59616217, 0.61846967, 0.22062059],
            [0.46166238, 0.44042084, 0.21356279],
            [0.55197041, 0.54271697, 0.21372037],
            [0.5694184 , 0.56500133, 0.20429916],
            [0.52086432, 0.52016312, 0.22438172]]),
