...
TimesFM 2.5 and Moirai-2 restrict quantiles to `[0.1, 0.2, …, 0.9]`; Chronos-2, TabICL, TabPFN-TS, TFC-T0 and Nori accept any quantile in `(0, 1)`. See the `foundation-forecasting` skill for details.
