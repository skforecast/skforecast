...
Core: numpy>=1.26, pandas>=2.1, scikit-learn>=1.4, scipy>=1.12, optuna>=4.0, joblib>=1.3, numba>=0.59, tqdm>=4.66, rich>=13.9
Optional: statsmodels>=0.12 (stats), matplotlib>=3.7 + seaborn>=0.12 (plotting), keras>=3.0 (deep learning)
...
├── plot/                    # Plotting utilities for forecasts and diagnostics
